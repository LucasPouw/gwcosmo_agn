...
\\&= \dfrac{p(s|z,\Omega,M,m,G,H_0,I)\delta(M - M(z,m,H_0))p(z,\Omega,m|H_0,G,I)}{p(s|G,H_0,I)} ??
\\&= \dfrac{p(s|z,\Omega,M(z,m,H_0),m,G,H_0,I)p(z,\Omega,m|H_0,G,I)}{p(s|G,H_0,I)} ??
\\&= \dfrac{p(s|z,M(z,m,H_0),I)p(z,\Omega,m|H_0,G,I)}{p(s|G,H_0,I)} ????
\end{aligned}
\end{equation}
\note{And as $M$ depends on $z$ in this case, I don't see a way of expanding out the term $p(s|z,M(z,m,H_0),I)$ in a way that makes logical sense.}
