...
\begin{aligned}
p(& x_{\text{GW}}|G, D_{\text{GW}}, H_0) = \dfrac{\sum^{N_\text{gal}}_{j=1} \int p(x_{\text{GW}}|z_j,\Omega_j,H_0)p(s|M(z_j,m_j,H_0)) p(z_j) dz_j}
{\sum^{N_\text{gal}}_{j=1} \int p(D_{\text{GW}}|z_j,\Omega_j,H_0)p(s|M(z_j,m_j,H_0)) p(z_j) dz_j}\,.
\end{aligned}
\end{equation}
