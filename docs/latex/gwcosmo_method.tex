...
\begin{equation}
\begin{aligned}
p(x_{\text{GW}}|H_0,G,I) &= \iiiint p(x_{\text{GW}}|z,\Omega,M,m,G,H_0,I) p(z,\Omega,M,m|G,H_0,I) dz d\Omega dM dm
...
\begin{equation}
\begin{aligned}
p(x_{\text{GW}}|H_0,G,I) &= \iiiint p(x_{\text{GW}}|z,\Omega,H_0,I) \dfrac{p(s|z,\Omega,M,m,G,H_0,I)\delta(M - M(z,m,H_0))p(z,\Omega,m|G,I)}{p(s|G,H_0,I)} dz d\Omega dM dm
...
\begin{equation}
\begin{aligned}
p(x_{\text{GW}}|H_0,G,I) &= \dfrac{1}{p(s|G,H_0,I)} \sum^N_{i=1} p(x_{\text{GW}}|z_i,\Omega_i,H_0,I) p(s|z_i,\Omega_i,M(z_i,m_i,H_0),m_i,H_0,I)
...
\begin{equation}
\begin{aligned}
\dfrac{p(x_{\text{GW}}|H_0,G,I)}{p(D_{\text{GW}}|G,H_0,I)} &= \dfrac{ \sum^N_{i=1} p(x_{\text{GW}}|z_i,\Omega_i,H_0,I) p(s|z_i,I)p(s|M(z_i,m_i,H_0),I)}{\sum^N_{i=1} p(D_{\text{GW}}|z_i,\Omega_i,H_0,I) p(s|z_i,I)p(s|M(z_i,m_i,H_0),I)}
\end{aligned}
\end{equation}
