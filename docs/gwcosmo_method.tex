...
%\begin{aligned}
%p(z|s,I) &= p(z|I)
%\\ p(\Omega|s,I) &= p(\Omega|I)
%\\ p(D|s,I) &= p(D|I)
%\\ p(x|s,I) &= p(x|I)^*
%\end{aligned}
%\end{equation}
%*this final one is actually debatable, given false detections, but it simplifies everything even further if we assume that every detection we make is due to a real signal.
...
%\begin{equation}
%\begin{aligned}
%p(x|H_0,G,D,I) &= \dfrac{\iiiint p(x|H_0,G,z,\Omega,m,M,I) p(z,\Omega,m,M|H_0,G,I) dz d\Omega dm dM}{\iiiint p(D|H_0,G,z,\Omega,m,M,I) p(z,\Omega,m,M|H_0,G,I) dz d\Omega dm dM}
%\\ &= \dfrac{\iiiint p(x|H_0,z,\Omega,I) p(z,\Omega,m,M|H_0,G,I) dz d\Omega dm dM}{\iiiint p(D|H_0,z,\Omega,I) p(z,\Omega,m,M|H_0,G,I) dz d\Omega dm dM}
%\end{aligned}
%\end{equation}
...
%\begin{equation}
%\begin{aligned}
%p(z,\Omega,m,M|H_0,G,I) &= p(M|H_0,z,\Omega,m,G,I)p(z,\Omega,m|H_0,G,I)
%\\ &= p(M|H_0,z,m,G,I)p(z,\Omega,m|G,I)
%\end{aligned}
%\end{equation}
%
%The form taken by $p(M|H_0,z,m,G,I)$ depends on how we believe a galaxy's absolute magnitude is related to its probability of being a GW host.
%\begin{equation}
%\begin{aligned}
%p(M|H_0,z,m,G,I) &= W[\delta(M(z,H_0,m))] \times Schechter(M(z,H_0,m))
%\end{aligned}
%\end{equation}
%where
%\begin{equation}
...
%W[\delta(M(z,H_0,m))] &= 
%\begin{cases}
%L(M(z,H_0,m)) & \text{if luminosity weighted}\\
...
%\begin{equation}
%\begin{aligned}
%p(x|H_0,G,D,I) &= \dfrac{\iiint p(x|H_0,z,\Omega,I) W[\delta(M(H_0,z,m))] p(z,\Omega,m|G,I) dz d\Omega dm}{\iiint p(D|H_0,z,\Omega,I) W[\delta(M(H_0,z,m))] p(z,\Omega,m|G,I) dz d\Omega dm}
%\\ &= \dfrac{\sum^N_{i=1} p(x|H_0,z_i,\Omega_i,I) W[\delta(M(H_0,z_i,m_i))]}{\sum^N_{i=1} p(D|H_0,z_i,\Omega_i,I) W[\delta(M(H_0,z_i,m_i))]}
%\end{aligned}
%\end{equation}
%
...
%\\ &= p(M(H_0,z,m)|s,H_0,G,I)p(z,\Omega,m|G,I)
%\\ &= \dfrac{p(s|M(H_0,z,m),H_0,G,I)p(M(H_0,z,m)|H_0,G,I)}{p(s|H_0,G,I)} p(z,\Omega,m|G,I)
%\\ &= \dfrac{p(s|M(H_0,z,m),I)\delta(M-M(H_0,z,m))}{p(s|H_0,G,I)} p(z,\Omega,m|G,I)
%\end{aligned}
%\end{equation}
